...
const crearCategoria = (genero)=>{
    ...
    const encabezado = `<h3 class="products__category-tittle">${genero}</h3>
 ...
 const crearProducto = (nombre, precio,img,id) =>{
    ...
    const contenido = `<a href="productoSeleccionado.html?id=${id}" class="product__img"><img src="${img}"alt="IMGXD"></a>
